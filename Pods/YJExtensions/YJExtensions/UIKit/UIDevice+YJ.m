...
+ (NSString *)yj_platformString{
    NSString *platform = [self yj_platform];
...
+ (NSUInteger)yj_getSysInfo:(uint)typeSpecifier
{
...
+ (NSUInteger)yj_cpuFrequency {
    return [self yj_getSysInfo:HW_CPU_FREQ];
}

+ (NSUInteger)yj_busFrequency {
    return [self yj_getSysInfo:HW_BUS_FREQ];
}

+ (NSUInteger)yj_ramSize {
    return [self yj_getSysInfo:HW_MEMSIZE];
}

+ (NSUInteger)yj_cpuNumber {
    return [self yj_getSysInfo:HW_NCPU];
}


+ (NSUInteger)yj_totalMemoryBytes
{
    return [self yj_getSysInfo:HW_PHYSMEM];
}
