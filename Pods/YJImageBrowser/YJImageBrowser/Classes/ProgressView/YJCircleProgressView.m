...
@interface YJCircleProgressLayer : CALayer
...
@implementation YJCircleProgressLayer
...
+ (void) initialize
{
    if (self == [YJCircleProgressView class]) {
        YJCircleProgressView *circularProgressViewAppearance = [YJCircleProgressView appearance];
...
+ (Class)layerClass
{
    return [YJCircleProgressLayer class];
}

- (YJCircleProgressLayer *)circularProgressLayer
{
    return (YJCircleProgressLayer *)self.layer;
}
